...
Steps:
   ...
   #. Open log-default.json ``less log-default.json``. You can notice we log all requests.
...
.. note:: You can notice in the ``nginx.conf`` file the referer to ``log-default.json`` and the remote syslog server (ELK) ``10.1.20.6:5144``


**Open Kibana in the Jumhost or via UDF access**
...
.. note:: You can notice the log content is similar to ASM and Adv. WAF
